...
hl.bind(MM .. " + " .. QM .. " + " .. QsWallpaperKey, hl.dsp.global("quickshell:wallpaper"), { description = "Wallpaper" })
hl.bind(MM .. " + " .. QM .. " + " .. QsColorSchemeKey, hl.dsp.global("quickshell:color_scheme"), { description = "Color Scheme" })
