-- Fluent Animation Style - Vertical Variant
hl.config({
  animations = {
    enabled = true,
...
hl.animation({ leaf = "windowsOut"          , enabled = true , speed = 5  , bezier = "easeInOutQuint" , style = "popin 75%" })
...
hl.animation({ leaf = "layers"              , enabled = true , speed = 5  , bezier = "easeInOutQuint" })
hl.animation({ leaf = "layersIn"            , enabled = true , speed = 5  , bezier = "easeInOutQuint" , style = "fade" })
hl.animation({ leaf = "layersOut"           , enabled = true , speed = 7  , bezier = "easeInOutQuint" , style = "fade" })
...
hl.animation({ leaf = "workspaces"          , enabled = true , speed = 7  , bezier = "easeOutQuint" , style = "slidefadevert 10%" })
hl.animation({ leaf = "workspacesIn"        , enabled = true , speed = 7  , bezier = "easeOutQuint" , style = "slidefadevert 10%" })
hl.animation({ leaf = "workspacesOut"       , enabled = true , speed = 5  , bezier = "easeOutQuint" , style = "slidefadevert 10%" })
