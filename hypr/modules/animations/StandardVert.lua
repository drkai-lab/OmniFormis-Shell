-- Standard Animation Style - Vertical Variant
hl.config({
    animations = {
        enabled = true,
    },
...
hl.animation({ leaf = "layersIn",      enabled = true, speed = 5,  bezier = "emphasizedDecel", style = "popin 80%" })
hl.animation({ leaf = "layersOut",     enabled = true, speed = 4,  bezier = "emphasizedAccel", style = "popin 80%" })
