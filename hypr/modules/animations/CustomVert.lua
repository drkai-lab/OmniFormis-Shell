-- Custom Animation Style - Vertical Variant
...
hl.animation({ leaf = "workspaces",    enabled = true, speed = 4,  bezier = "customExpressiveSpatialSlow", style = "slidevert" })
hl.animation({ leaf = "workspacesIn",  enabled = true, speed = 4,  bezier = "customExpressiveSpatialFast", style = "slidevert" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 4,  bezier = "customExpressiveSpatialSlow", style = "slidevert" })
