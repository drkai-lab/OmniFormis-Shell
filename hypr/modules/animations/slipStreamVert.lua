-- slipStream Animation Style - Vertical Variant
hl.config({
    animations = {
        enabled = true,
    },
...
hl.animation({ leaf = "layersIn",      enabled = true, speed = 5,  bezier = "winIn",   style = "popin 80%" })
hl.animation({ leaf = "layersOut",     enabled = true, speed = 4,  bezier = "winOut",  style = "popin 80%" })
