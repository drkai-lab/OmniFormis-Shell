...
Item {
    ...
    property color targetColor: isSelected ? Theme.secondary_container : (btMouse.containsMouse ? Qt.tint(Theme.surface_container, Qt.rgba(Theme.on_surface.r, Theme.on_surface.g, Theme.on_surface.b, 0.08)) : Theme.surface_container)
    ...
    RowLayout {
        ...
        Item {
            ...
            Text { anchors.centerIn: parent; text: modelData.connected ? "\ue1a8" : "\ue1a7"; font.family: modelData.connected ? filledIconFont.name : "Material Symbols Outlined"; font.pixelSize: 24; color: modelData.connected ? Theme.primary : Theme.on_surface_variant }
        }
        ColumnLayout {
